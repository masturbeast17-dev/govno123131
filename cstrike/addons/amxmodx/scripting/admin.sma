...
#endif
	register_cvar("amx_sql_host", "193.23.220.9", FCVAR_PROTECTED)
	register_cvar("amx_sql_user", "u20_hJ7Pe1cy7ct", FCVAR_PROTECTED)
	register_cvar("amx_sql_pass", "iECDRPWcp9wD+lWnuR.XH=Cf", FCVAR_PROTECTED)
	register_cvar("amx_sql_db", "s20_amx", FCVAR_PROTECTED)
